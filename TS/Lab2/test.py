...
# randomowe liczby z przedziału 1-99, ustawiamy rozmiar macierzy na 20 x 20
...
# czy przyjąc jakąś wartość z góry, czy każdemu n(i,j) przpisać maksymymalną
# ustaloną wartość z random.randint? 
